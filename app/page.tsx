...
export default function Home() {
  return (
    <>
      <Navbar />
      <div className="flex-col items-center justify-center text-center mx-[30%] mt-[10%] mb-[5%]">
        <h1 className="text-4xl font-medium">Find books worth remembering.</h1>
        <p className="font-light text-lg text-white/95">Because screenshots of book covers don’t count.</p>
      </div>
      <div className="mx-[30%] items-center text-center text-xl">
        <p className="font-regular text-white/90">Search books and add them to your reading list. <br />
          Check reviews, read summaries, and track what you love.</p>
      </div>

      <div className="mx-[32%] mt-[4%] flex justify-between">
      ...
      <div className="mx-[30%] mt-8 flex justify-center">
        <button
